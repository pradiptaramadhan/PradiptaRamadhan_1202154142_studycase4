package android.example.com.pradiptaramadhan_1202154142_studycase4;
...
public class ListMahasiswa extends AppCompatActivity implements View.OnClickListener {
    ...
    private String[] namaMahasiswa = {"Dipta", "Karius", "Mignolet", "Matip", "Vandijk", "Moreno", "Gomez",
            "Emre", "Handerson", "Mane", "Salah", "Coutinho", "Arnold", "Lukaku", "Hazard", "Bale", "Kante", "Messi"};
